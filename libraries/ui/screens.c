...
static const char *object_names[] = { "main", "containers_screen", "zap_screen", "boot_logo", "button_zap", "button_exit", "keyboard_zap_number", "label_main_screen", "container_main", "button_settings", "container_establish", "button_info", "label_zap_screen", "container_zap_number", "textarea_zap_number" };
